...
function JavaScriptToken(myna)
{
    ...
    this.doubleQuotedStringContents = m.not('"').then(stringLiteralChar).star.ast;
    this.singleQuotedStringContents = m.not("'").then(stringLiteralChar).star.ast;
    ...
    this.regexClass = m.seq('[', this.regexClassChar.star, ']').ast;
    ...
    this.commonToken = m.choice(this.nullLiteral, this.regexLiteral, this.identifierName, this.numericLiteral, this.stringLiteral, this.punctuator,
